<script lang="ts">
  ...
  let { children, onclick, disabled = false, primary = false, type = 'button' }: {
    children: import('svelte').Snippet; onclick?: () => void; disabled?: boolean; primary?: boolean; type?: 'button' | 'submit';
  } = $props();
</script>
